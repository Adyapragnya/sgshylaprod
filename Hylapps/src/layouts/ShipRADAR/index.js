    ...
    <DashboardLayout>
      ...
      <ArgonBox py={3}>
        ...
        <Grid item xs={12} md={12} style={{cursor:'pointer'}}>
            <h3 style={{color:'#0F67B1',marginBottom:'5px'}}>Ships Within 6 hours<sup style={{color:"orange",fontSize:"12px"}}>(Under Development)</sup></h3>
              <VesselSixhours
          ...
          <Grid item xs={12} md={12} style={{cursor:'pointer'}}>
            <h3 style={{color:'#0F67B1',marginBottom:'5px'}}>Ships Within 24 hours<sup style={{color:"orange",fontSize:"12px"}}>(Under Development)</sup></h3>
              <Vesseleighthours
                  vesselEntries={vesselEntries}
                  vessels={vessels}
                  onRowClick={handleRowClick}
          ...
          <Grid item xs={12} md={12} style={{cursor:'pointer'}}>
          <h3 style={{color:'#0F67B1',marginBottom:'5px'}}>Ships beyond 24 hours <sup style={{color:"orange",fontSize:"12px"}}>(Under Development)</sup></h3>
